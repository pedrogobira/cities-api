...
import com.github.yofiel.citiesapi.service.CityDistanceService;
...
public class CityDistanceController {
    ...
    Logger log = LoggerFactory.getLogger(CityDistanceController.class);

    @Autowired
    public CityDistanceController(CityDistanceService service) {
